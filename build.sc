...
val builders: List[Builder] = List(
	...
	Builder("Kompact-no-reuse", relp("kompact-no-reuse"), cargoEnv, cargo, cargoBuildCmd, Seq("clean")),
	Builder("Kompact-no-reuse-in", relp("kompact-no-reuse-in"), cargoEnv, cargo, cargoBuildCmd, Seq("clean")),
	Builder("Kompact-no-reuse-out", relp("kompact-no-reuse-out"), cargoEnv, cargo, cargoBuildCmd, Seq("clean")),
