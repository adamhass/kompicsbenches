...
-define(benchmarks_pb_gpb_version, "4.11.1").

-ifndef('PINGPONGREQUEST_PB_H').
-define('PINGPONGREQUEST_PB_H', true).
-record('PingPongRequest',
        {number_of_messages = 0 :: non_neg_integer() | undefined % = 1, 64 bits
        }).
-endif.
...
-record('ThroughputPingPongRequest',
        {messages_per_pair = 0  :: non_neg_integer() | undefined, % = 1, 64 bits
         pipeline_size = 0      :: non_neg_integer() | undefined, % = 2, 64 bits
...
-record('AtomicRegisterRequest',
        {read_workload = 0.0    :: float() | integer() | infinity | '-infinity' | nan | undefined, % = 1
         ...
         number_of_keys = 0     :: non_neg_integer() | undefined % = 4, 64 bits
        }).
-endif.
